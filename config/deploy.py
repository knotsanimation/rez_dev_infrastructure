...
def get_current_commit() -> str:
    """
    Return the hash of the latest commit this repository is currently at.
    """
    commit = subprocess.check_output("git rev-parse HEAD", cwd=THISDIR)
...
def deploy_config(config_path: Path, target_dir: Path):
    ...
    header = (
        ...
        f"# last commit = {get_current_commit()}\n"
